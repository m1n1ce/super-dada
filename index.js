...
playerBulletImage.src = 'dada_bullet.jpeg'; 
...
function draw() {
  ...
  if (gameState === 'playing') {
    ...
    ctx.fillStyle = '#000';
    ctx.font = '20px Arial';
    const gameOverTextHS = 'Novi skor ! Osvojili ste kupon.';
    ...
    image.onload = function () {
        ctx.drawImage(image, canv.width / 2 - 140, canv.height / 2 - 25, 300, 240);
    };
...
function generateRandomEnemy() {
  if (enemies.length < 7) {
    ...
    const enemyImages = ['ismeta.png', 'emina.png', 'ilma.png', 'osman.png', 'edina.png', 'melika.png'];
...
function showWelcomePopup() {
  ...
  const enemyDescriptions = {
    'ismeta.png': 'Pospani Mjau - Hipnotizuje te u zimski san.',
    'osman.png': 'Posljednji Medenjak - Naravno ako ne pojede sve, onda ostane bez municije, a ti ostaneš gladan.',
    'melika.png': 'Leteci Paket - Kad te pogodi, računaj manjak depozita narednih nekoliko dana.',
    'emina.png': 'Brzi Mini - sklon\' s puta!',
    'edina.png': 'Radnička Munja - Kad te pogodi kovertom, tačno ti se zamanta.',
    'ilma.png': 'Opasni Popust - Ako te pogodi, odmah uštediš 0.20 KM.'
  };
